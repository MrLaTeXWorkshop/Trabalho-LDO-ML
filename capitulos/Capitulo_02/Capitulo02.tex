...
\begin{document}
    ...
    \begin{center}
        \href{run:./Capitulo02.mp3}{Escute esse PDF!}
    ...
    crescido desde o \href{run:../Capitulo_01/Capitulo01.pdf}{Game of Checkers}, mas não é 
    ...
    Vamos listar aqui mais dois exemplos,mas saiba que na seção \ref{sec:extra}, você encontrará mais links sobre o assunto “Machine Learning no cotidiano”, inclusive
    ...
    Todos os vídeos na plataforma YouTube possuem uma característica muito importante
